local function xbase_config(root_dir)
  return {
...
return {
  {
    ...
    config = function()
      local root_dir = require("lspconfig").util.root_pattern("Package.swift", ".git", "project.yml", "Project.swift")
      require "xbase".setup(xbase_config(root_dir))
    end
  }
}
